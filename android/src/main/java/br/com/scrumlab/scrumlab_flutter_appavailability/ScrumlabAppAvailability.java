package br.com.scrumlab.scrumlab_flutter_appavailability;
...
/** ScrumlabAppAvailability */
public class ScrumlabAppAvailability implements MethodCallHandler {

  private final Activity activity;
  private final Registrar registrar;

  public ScrumlabAppAvailability(Registrar registrar, Activity activity) {
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "br.com.scrumlab/scrumlab_flutter_appavailability");
    channel.setMethodCallHandler(new ScrumlabAppAvailability(registrar, registrar.activity()));
  }
