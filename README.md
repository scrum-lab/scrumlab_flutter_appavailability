# Scrumlab Flutter ScrumlabAppAvailability Plugin

[![Pub](https://img.shields.io/pub/v/scrumlab_flutter_appavailability.svg)](https://pub.dartlang.org/packages/scrumlab_flutter_appavailability)

A Flutter plugin that allows you to check if an app is installed/enabled, launch an app and get the list of installed apps.

This plugin was inspired by the plugin [ScrumlabAppAvailability for Cordova](https://github.com/ohh2ahh/ScrumlabAppAvailability).
...
## Installation
First, add `scrumlab_flutter_appavailability` as a [dependency in your pubspec.yaml file](https://flutter.io/using-packages/).
...
See the [docs](https://pub.dartlang.org/documentation/scrumlab_flutter_appavailability/latest/).
            ...
            return ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () {
                  ...
                  ScrumlabAppAvailability.launchApp(installedApps[index]["package_name"]).then((_) {
